...
export const translations: Record<LanguageCode, TranslationDictionary> = {
  ...
  mr: {
    ...
    languageSelectTitle: "आपली पसंदीची भाषा निवडा",
    ...
    consentSubtitle: "आपली वैद्यकीय माहिती कशी एकत्र केली जाती.",
    consentBody: "मेडीकिओस्क केवळ आपल्या तपासणी डॉक्टरांच्या सोयीसाठी आपले लक्षणे व जुन्या पावत्यांची माहिती व्यवस्थित एकत्र करते. ही प्रणाली कोणताही स्वतंत्र रोगनिदान अथवा औषधोपचार ठरवत नाही. तपासणी डॉक्टर सर्व माहितीची खात्री करतील.",
    consentCheckbox: "मी डॉक्टरांच्या तपासणीसाठी एआय-सहाय्यक माहिती संकलनेस संमती देतो/देते.",
    ...
    allergies: "औषध किंवा अन्नाची अलर्जी",
